...
| `GET /v3/snapshot` | none | `SnapshotResponse { schema_version, tracks, plan, health, requirements, bearing_rays, pipeline_stats, queue }` | `picture.view` | Yes (GAP-041); `bearing_rays`/`pipeline_stats` GAP-096; `queue` GAP-132; lossless floats GAP-153 |
