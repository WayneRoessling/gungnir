...
| Note | State | Where |
|---|---|---|
| DN-01 Defended assets | **Implemented and wired** (GAP-026) | `gungnir-model/src/assets.rs`, the asset section and its validation in `gungnir-config`, `gungnir-assessment/src/assets.rs`; `sustainment::asset_assessor` scores the picture against it and PN-06 draws the score |
