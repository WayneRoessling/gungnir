...
| `serde_json` (`float_roundtrip`) | JSON configuration baselines, the JSON-lines journal, recorded feeds and report export | `float_roundtrip` always, so a journaled or exchanged double reads back bit for bit; without it about one double in eleven came back one ULP off | Sign-off of 2026-09-04; the feature, the GAP-067 walk of 2026-09-16 | [Approved stack additions](record/2026-09-16/stack-sign-offs.md#approved-stack-additions-signed-off-2026-09-04), [the walk](record/2026-09-16/gap-067-walk.md) |
