...
| GAP-163 The audit log is written and never read back: no retention, no anchor for its head, and PN-20 shows one run | CAP-6.3 | 2 | M | I3 | GAP-111 (`../../record/2026-09-26/the-security-row-tested-and-the-node-audited.md`) |
