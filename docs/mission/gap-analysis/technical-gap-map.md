...
## The §10 open items of 2026-09-04 and the gaps that carried them
...
| GAP-166 nalgebra's decompositions violate Stacked Borrows | CAP-7.4 | 2 | S | I2 | Found running the repaired miri gate (`../../record/2026-09-26/the-miri-gate-had-never-run-miri.md`) |
...
| GAP-117 Most event and view types are never round-tripped through serde | CAP-7.2 | 2 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-136 A rehearsal read its picture before the pipeline had reported the run | CAP-5.2 | 3 | S | I3 | Found by CI while building GAP-131 (`../../record/2026-09-17/a-rehearsal-that-measured-the-machine.md`) |
| GAP-175 A global entity identity is written as a 128-bit JSON number | CAP-7.2, CAP-2.7 | 2 | S | I3 | Found by GAP-117's round trip (`../../record/2026-09-26/the-interop-model-and-observability-rows-get-their.md`) |
...
| GAP-114 Nothing consumes LateDataPolicy | CAP-1.5 | 2 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-115 The node never times out an unacknowledged sensor task | CAP-1.3 | 3 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-173 The late-data row still says nothing consumes the policy | CAP-1.5 | 3 | S | I3 | GAP-114 (`../../record/2026-09-26/the-late-data-policy-governs-the-tracker.md`) |
...
| GAP-123 An entity's GlobalEntityId changes at every restart | CAP-2.7 | 4 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
...
| GAP-113 An under-authority plan is counted, never escalated | CAP-3.6, CAP-4.3 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-118 Coverage accuracy is untested, and a coverage volume has no bearing | CAP-2.11 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-119 No solve budget exists, and a stale plan is never compared with the last good one | CAP-3.3, CAP-5.5 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-124 The risk score has no time-to-impact term | CAP-3.2 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-130 Decision, plan and queue-item identifiers collide across machines and restarts | CAP-7.2, CAP-4.2 | 4 | M | I3 | DN-31, the node approval queue (`../../design/DN-31-node-approval-queue.md`) |
| GAP-131 The decision path lives only in gungnir-app | CAP-4.2, CAP-3.6 | 3 | L | I3 | DN-31, the node approval queue (`../../design/DN-31-node-approval-queue.md`) |
| GAP-135 An effector's report moves an engagement without putting the move on the record | CAP-4.6 | 3 | S | I3 | Found building GAP-130 (`../../record/2026-09-17/identifiers-uuid-v7-and-v3-routes.md`) |
| GAP-158 A coverage volume's elevation limit is one floor for every sensor, against the frame's vertical | CAP-2.11 | 2 | M | I3 | Found closing GAP-118 (`../../record/2026-09-25/time-to-impact-and-sensor-sectors.md`) |
| GAP-156 A picture the exact solver cannot finish in time is never answered | CAP-3.3 | 3 | M | I3 | Found building GAP-119 (`../../record/2026-09-25/a-stale-plan-says-how-old-it-is.md`) |
...
| GAP-122 Journal retention purge is unbuilt, and nothing says so | CAP-5.1 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-125 Neither binary's health path is tested against a changing flag | CAP-5.5 | 2 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-126 A non-finite float in an envelope cannot be journaled faithfully | CAP-5.1 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-128 PN-14 cannot apply an edited baseline on its first apply | CAP-5.6 | 3 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
...
| GAP-111 The security row's role matrix and audit rule are untested, and the node audits nothing | CAP-6.2, CAP-6.3 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-127 The desktop's decide and task functions check no permission | CAP-6.2 | 3 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-141 A desktop has no identity of its own | CAP-6.1, CAP-5.4 | 2 | M | I3 | Found building GAP-134 (`../../record/2026-09-17/an-outage-reaches-the-node-once.md`) |
| GAP-152 The audit log lives in memory, so nothing outlives the process and no age governs it | CAP-6.3 | 3 | M | I3 | Found building GAP-122 (`../../record/2026-09-25/every-float-kept-old-sessions-purged-on-purpose.md`) |
| GAP-162 A sensor manager may apply a whole baseline, and applying one checks no permission | CAP-6.2, CAP-5.6 | 3 | M | I3 | GAP-111 (`../../record/2026-09-26/the-security-row-tested-and-the-node-audited.md`) |
| GAP-163 A cut tail of the audit log still verifies, because nothing outside it holds its head | CAP-6.3 | 2 | M | I3 | GAP-111 (`../../record/2026-09-26/the-security-row-tested-and-the-node-audited.md`) |
...
| GAP-110 The node's headless loop has no automated test | CAP-7.3 | 2 | S | I3 | The GAP-067 walk of 2026-09-16, Group C (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-112 No test round-trips a fully populated v2 snapshot | CAP-7.1 | 2 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-116 Seven interop clauses are unasserted or only partly asserted | CAP-7.2 | 2 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-120 Nothing compares the embedded and remote backends' projections | CAP-7.3 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-121 StoreAndForwardQueue has no production caller | CAP-5.4 | 1 | S | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-129 No decision reaches a node's record, so reconciliation never meets a conflict | CAP-5.4 | 3 | M | I3 | The GAP-067 walk of 2026-09-16 (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-132 A node runs no approval queue | CAP-4.2, CAP-4.3, CAP-3.7, CAP-6.2 | 4 | L | I3 | DN-31, the node approval queue (`../../design/DN-31-node-approval-queue.md`) |
| GAP-134 A desktop's offline decisions never reach its node | CAP-5.4 | 3 | M | I3 | DN-31, the node approval queue (`../../design/DN-31-node-approval-queue.md`) |
| GAP-137 A handoff the node issues reaches no exchange partner | CAP-5.7 | 2 | S | I3 | Found building GAP-132 (`../../record/2026-09-17/the-node-runs-the-approval-queue.md`) |
| GAP-138 An unreachable decision type still describes the interface | CAP-5.7 | 1 | S | I3 | Found building GAP-132 (`../../record/2026-09-17/the-node-runs-the-approval-queue.md`) |
| GAP-142 A desktop that restarts during an outage forgets it | CAP-5.4 | 3 | M | I3 | Found building GAP-134 (`../../record/2026-09-17/an-outage-reaches-the-node-once.md`) |
| GAP-143 A sign-in during an outage ends it without a person switching back | CAP-5.4, CAP-6.1 | 3 | S | I3 | Found building GAP-134 (`../../record/2026-09-17/an-outage-reaches-the-node-once.md`) |
| GAP-145 The exchange register has no lifecycle | CAP-7.4 | 3 | M | I3 | Found building GAP-137 (`../../record/2026-09-23/a-partner-hears-what-the-node-decided.md`) |
| GAP-146 A console that may not publish queues its handoffs for ever | CAP-7.4 | 3 | S | I3 | Found building GAP-145 (`../../record/2026-09-23/a-register-that-says-how-old-it-is.md`) |
| GAP-150 A console's mission report is not published again when its link comes back | CAP-7.4 | 3 | S | I3 | Found building GAP-146 (`../../record/2026-09-25/a-console-that-may-not-publish-says-so.md`) |
| GAP-153 A non-finite float in an envelope breaks the v3 stream and history | CAP-7.1, CAP-5.4 | 2 | S | I3 | Found building GAP-126 (`../../record/2026-09-25/every-float-kept-old-sessions-purged-on-purpose.md`) |
| GAP-160 A node publishes no track, so a linked desktop's picture is frozen at sign-in | CAP-7.3 | 5 | S | I3 | Found building GAP-120 (`../../record/2026-09-25/one-scenario-through-both-backends.md`) |
| GAP-161 A linked desktop's health strip reports the link, not the node's services | CAP-7.3 | 4 | S | I3 | Found building GAP-120 (`../../record/2026-09-25/one-scenario-through-both-backends.md`) |
| GAP-157 A linked desktop cannot tell that its node's planner is stale | CAP-3.3, CAP-7.3 | 3 | M | I3 | Found building GAP-119 (`../../record/2026-09-25/a-stale-plan-says-how-old-it-is.md`) |
| GAP-165 A linked desktop's node session lapses and nothing renews it while the link is up | CAP-7.3 | 5 | S | I3 | Found building GAP-120 (`../../record/2026-09-25/one-scenario-through-both-backends.md`) |
| GAP-171 The other v3 bodies, and every exchange product's body, still write a non-finite float as null | CAP-7.1, CAP-7.4 | 3 | M | I3 | Found building GAP-153 (`../../record/2026-09-26/the-report-and-every-float-reach-the-partner.md`) |
| GAP-169 An older desktop reads a newer node's interim plan as the optimum | CAP-3.3, CAP-7.3 | 2 | S | I3 | Found building GAP-156 (`../../record/2026-09-26/interim-plans-and-a-linked-plan-s-age.md`) |
...
| GAP-109 Nothing counts per-frame resource creation in gungnir-render | CAP-5.10 | 2 | S | I3 | The GAP-067 walk of 2026-09-16, Group C (`../../record/2026-09-16/gap-067-walk.md`) |
| GAP-133 A linked desktop decides the node's plans itself | CAP-5.9, CAP-4.3 | 4 | M | I3 | DN-31, the node approval queue (`../../design/DN-31-node-approval-queue.md`) |
| GAP-140 A node's deadline is drawn against the desktop's own clock | CAP-5.9, CAP-3.7 | 2 | S | I3 | Found building GAP-133 (`../../record/2026-09-17/a-linked-desktop-shows-the-node-s-queue.md`) |
...
| GAP-139 An If-Sr diagram no longer renders under the layout its generator pins | CAP-7.1 | 2 | S | I3 | Found building GAP-132 (`../../record/2026-09-17/the-node-runs-the-approval-queue.md`) |
| GAP-144 The release passes only by accepting two quick-xml advisories | CAP-6.5 | 3 | M | I2 | `../../record/2026-09-17/egui-0-34-and-three-d-0-19.md`; the first release runs in `../../record/2026-09-17/release-workflow-first-runs.md` |
| GAP-154 The Disconnected reconciliation row still says no decision reaches a node's record | CAP-5.4 | 1 | S | I3 | Found closing GAP-129 (`../../record/2026-09-25/housekeeping-after-dn-31.md`) |
| GAP-159 The Coverage accuracy row still says a coverage volume has no bearing | CAP-2.11 | 1 | S | I3 | Found closing GAP-118 (`../../record/2026-09-25/time-to-impact-and-sensor-sectors.md`) |
| GAP-147 No committed recording reaches round 1's radars | CAP-5.2, CAP-1.4 | 2 | M | I3 | GAP-105 (the rehearsal); D-28 (round 1's laydown `c`); `../../ux/usability-round-1-session.md` US-15; `../../record/2026-09-25/gap-105-re-observation-for-a-laydown-built.md` |
| GAP-167 The outage tests' proxy can let one connection through a cut | CAP-5.4 | 2 | S | I3 | Found building GAP-165 (`../../record/2026-09-26/the-outage-tests-proxy-held-a-socket-open.md`) |
| GAP-164 The miri gate could not run miri | CAP-7.4 | 3 | S | I2 | Found merging GAP-124 (`../../record/2026-09-26/the-miri-gate-had-never-run-miri.md`) |
| GAP-168 The intercept-service row's degradation clause stops at the last good plan | CAP-3.3, CAP-5.5 | 1 | S | I3 | Found closing GAP-156 (`../../record/2026-09-26/interim-plans-and-a-linked-plan-s-age.md`) |
| GAP-170 PN-09's refusal test left its wait before the desktop had seen its link | CAP-7.3 | 1 | S | I3 | Found watching PR #182's tests (`../../record/2026-09-26/interim-plans-and-a-linked-plan-s-age.md`) |
