...
| GAP-101 ASTERIX Category 129 UAS identification reports | CAP-1.7 | 3 | M | I3 | `../../../ARCHITECTURE.md` §10 item 123, item 129; GAP-001 (the survey and the sibling feeds); GAP-064 (the ASTERIX/STANAG codec family this extends); GAP-100 (the sibling gap this one was left open beside, and the pattern it mirrors) |
