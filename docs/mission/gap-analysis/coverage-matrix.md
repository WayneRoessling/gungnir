...
|---|---|---|---|---|
| CAP-1.1 Ingest observations | full | partial | `gungnir-ingest` gateway and adapter trait; `gungnir-interop` codec boundary; `DetectionView` carries provenance | GAP-001, GAP-064, GAP-099, GAP-100, GAP-104 |
...
| CAP-1.4 Coverage and gaps | full | partial | Coverage volumes in `gungnir-analytics`; gap detection as a function and map rendering of coverage are not designed; a component is now named for every part of it by DN-12 (`../../design/`, first draft 2026-09-05) | GAP-006, GAP-007, GAP-105, GAP-106 |
...
| CAP-2.1 Multi-sensor picture | full | partial | Tracking core trait surfaces, `gungnir-fusion-async`, `gungnir-tracking-service` facade | GAP-011, GAP-016, GAP-048, GAP-066, GAP-096, GAP-103, GAP-104 |
...
| CAP-2.10 Terrain and map context | full | partial | `gungnir-data` loaders, `gungnir-data-fusion`, `gungnir-geo` layers, `gungnir-viewport3d` scene | GAP-014, GAP-022, GAP-023, GAP-024, GAP-098, GAP-102, GAP-108 |
...
| CAP-3.3 Assignment recommendation | full | partial | `gungnir-allocation` value function and `gungnir-intercept-service`; effector layers and costs have no model in `ResourceConfig`; a component is now named for every part of it by DN-04 (`../../design/`, first draft 2026-09-05) | GAP-029, GAP-030, GAP-097 |
...
| CAP-5.2 Replay and rehearse | partial | partial | `gungnir-replay` over journals; scenario replay through the live pipeline under a chosen plan is not designed; plan 07 for scenarios | GAP-071, GAP-045, GAP-046, GAP-076, GAP-051, GAP-087, GAP-105, GAP-107 |
