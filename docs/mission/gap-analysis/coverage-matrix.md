...
| CAP-2.7 Global identity | full | partial | `gungnir-identity` resolver with lineage; cross-session correlation is an `../../../ARCHITECTURE.md` §10 item | GAP-019, GAP-069, GAP-123 |
...
| CAP-7.2 Interop standards | full | partial | `SchemaCatalog` with Arrow; codecs pending | GAP-069, GAP-063, GAP-064, GAP-100, GAP-116, GAP-117, GAP-130 |
