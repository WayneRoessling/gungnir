...
| CAP-5.2 Replay and rehearse | partial | partial | `gungnir-replay` over journals; scenario replay through the live pipeline under a chosen plan is not designed; plan 07 for scenarios | GAP-071, GAP-045, GAP-046, GAP-076, GAP-051, GAP-087, GAP-105, GAP-107, GAP-136 |
