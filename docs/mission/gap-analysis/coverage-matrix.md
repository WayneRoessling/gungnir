...
| CAP-5.4 Disconnected and reconcile | full | partial | `gungnir-remote`, `gungnir-resilience`, `gungnir-collab`; mid-session failover waits on the transport | GAP-041, GAP-072, GAP-050, GAP-121, GAP-129, GAP-134 |
