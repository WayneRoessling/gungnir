...
| CAP-7.1 Versioned interface | full | partial | `../../gungnir-api-v1.md` contract; the read paths are served over HTTP and a WebSocket as of 2026-09-05 (GAP-041), loopback only and with the write paths refusing until a caller can be authenticated | GAP-041, GAP-063, GAP-066, GAP-112, GAP-139, GAP-153 |
...
| CAP-7.4 Peer and coalition exchange | full | none | API and interop provide the mechanism; releasability and peer merge are not designed; a component is now named for every part of it by DN-18 (`../../design/`, first draft 2026-09-05) | GAP-065, GAP-091, GAP-145, GAP-146, GAP-150, GAP-164, GAP-166 |
