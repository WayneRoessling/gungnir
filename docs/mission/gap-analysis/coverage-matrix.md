...
| CAP-5.4 Disconnected and reconcile | full | partial | `gungnir-remote`, `gungnir-resilience`, `gungnir-collab`; mid-session failover waits on the transport | GAP-041, GAP-072, GAP-050, GAP-121, GAP-129, GAP-134, GAP-141, GAP-142, GAP-143 |
...
| CAP-6.3 Audit | full | partial | `gungnir-security` audit log; wiring pending | GAP-059, GAP-111, GAP-163 |
...
| CAP-7.1 Versioned interface | full | partial | `../../gungnir-api-v1.md` contract; the read paths are served over HTTP and a WebSocket as of 2026-09-05 (GAP-041), loopback only and with the write paths refusing until a caller can be authenticated | GAP-041, GAP-063, GAP-066, GAP-112, GAP-139 |
