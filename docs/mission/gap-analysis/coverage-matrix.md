...
| CAP-5.5 Health and alert lifecycle | full | full | `gungnir-observability` and `gungnir-workflow` implemented | GAP-072, GAP-119, GAP-125 |
...
| CAP-7.3 Three profiles | full | partial | `../../../ARCHITECTURE.md` §8 profiles; both binaries run | GAP-041, GAP-110, GAP-120, GAP-160, GAP-161, GAP-157, GAP-165 |
