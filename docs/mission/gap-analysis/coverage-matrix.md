...
| CAP-1.5 Time discipline | full | partial | `gungnir-time` clocks and late-data policy; `DetectionView` source and receipt time | GAP-008, GAP-114 |
...
| CAP-7.3 Three profiles | full | partial | `../../../ARCHITECTURE.md` §8 profiles; both binaries run | GAP-041, GAP-110, GAP-120, GAP-160, GAP-161, GAP-157, GAP-165, GAP-169 |
