...
| CAP-2.10 Terrain and map context | full | partial | `gungnir-data` loaders, `gungnir-data-fusion`, `gungnir-geo` layers, `gungnir-viewport3d` scene | GAP-014, GAP-022, GAP-023, GAP-024, GAP-098, GAP-102 |
