...
| CAP-7.4 Peer and coalition exchange | full | none | API and interop provide the mechanism; releasability and peer merge are not designed; a component is now named for every part of it by DN-18 (`../../design/`, first draft 2026-09-05) | GAP-065, GAP-091, GAP-145, GAP-146, GAP-150 |
