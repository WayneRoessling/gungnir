...
| CAP-3.7 Queue under saturation | full | partial | `gungnir-command` pending list; ordering by priority and time remaining and pre-delegation are not designed; a component is now named for every part of it by DN-10 (`../../design/`, first draft 2026-09-05) | GAP-034, GAP-035, GAP-132 |
