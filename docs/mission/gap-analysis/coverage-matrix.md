...
|---|---|---|---|---|
| CAP-1.1 Ingest observations | full | partial | `gungnir-ingest` gateway and adapter trait; `gungnir-interop` codec boundary; `DetectionView` carries provenance | GAP-001, GAP-064, GAP-099, GAP-100, GAP-103 |
