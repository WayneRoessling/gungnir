...
| CAP-3.3 Assignment recommendation | full | partial | `gungnir-allocation` value function and `gungnir-intercept-service`; effector layers and costs have no model in `ResourceConfig`; a component is now named for every part of it by DN-04 (`../../design/`, first draft 2026-09-05) | GAP-029, GAP-030, GAP-097, GAP-119 |
...
| CAP-7.3 Three profiles | full | partial | `../../../ARCHITECTURE.md` §8 profiles; both binaries run | GAP-041, GAP-110, GAP-120, GAP-160, GAP-161 |
