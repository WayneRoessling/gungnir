...
| CAP-4.3 Never execute without a decision | full | full | Recommendation-only rule in `../../gungnir-capabilities.md` §5.4; `PolicyChain` never self-approves | GAP-039, GAP-113 |
...
| CAP-5.4 Disconnected and reconcile | full | partial | `gungnir-remote`, `gungnir-resilience`, `gungnir-collab`; mid-session failover waits on the transport | GAP-041, GAP-072, GAP-050, GAP-121, GAP-129 |
...
| CAP-6.2 Authorize by role, class, layer | partial | partial | `role_permits` coarse matrix; per-class and per-layer refinements are gaps (`roles-and-stakeholders.md` §4) | GAP-068, GAP-058, GAP-111, GAP-127 |
...
| CAP-7.2 Interop standards | full | partial | `SchemaCatalog` with Arrow; codecs pending | GAP-069, GAP-063, GAP-064, GAP-100, GAP-116, GAP-117 |
