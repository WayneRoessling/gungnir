...
| PN-16 Planning | `gungnir-ui/src/panels/planning.rs` (new) | baselines, coverage per option, rehearsal records | draft, submit | **GAP-087**, filed 2026-09-05 out of GAP-055 after three entries had been named for this panel in turn and none of them built one: GAP-006 is the coverage-gap analytics function, GAP-026 supplies the defended-asset list, GAP-045 the rehearsal records. **One of its two blockers is cleared 2026-09-06**: DN-26 (laydown options) gives a laydown a schema and an identity, and is signed by the owner 2026-09-06. GAP-045's rehearsal record was blocked on GAP-011, which is now closed. Nothing of the panel is built |
