...
allow-list in [`deny.toml`](./deny.toml); their notices, and those of the fonts egui
embeds in `gungnir-app`, ship with every release as `THIRD-PARTY-NOTICES.md`,
generated by `cargo about` from [`about.toml`](./about.toml).
